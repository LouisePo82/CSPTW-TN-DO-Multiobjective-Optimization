...
def main() -> None:
    ...
    assert solution.validator_pass, (
        "Shared validator rejected the C101-25 "
    ...
    report_path = (
        output_dir
        / "c101_25_initial_feasibility_se2a.json"
    )
    ...
    print(
        "[PASS] C101-25 paper initial solution is constructed"
    )
    print(
    ...
    print(
        "\nSE-2A — SOLOMON INITIAL FEASIBILITY PASSED"
    )

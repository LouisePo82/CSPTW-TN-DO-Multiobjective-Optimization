...
def main() -> None:
    ...
    print(
        "[PASS] C101-25 initial solution is accepted by shared visualization"
    )
    print(
    ...
    print(
        "\nSE-2B — SOLOMON SHARED ROUTE VISUALIZATION PASSED"
    )
